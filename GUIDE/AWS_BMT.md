...
FK_CO_CP_CC2 COMPANY_COMPETITOR DISABLED TIBERO
...
FK_T_HH_CC2 HOLDING_HISTORY DISABLED TIBERO
...
- Check if the constraints are enabled/disabled.
...
```
CONSTRAINT_NAME TABLE_NAME STATUS R_OWNER
FK_AD_C_CC CUSTOMER ENABLED ZREF
FK_AD_CO_CC COMPANY ENABLED ZREF
FK_AD_EX_CC EXCHANGE ENABLED ZREF
FK_B_CA_CC CUSTOMER_ACCOUNT ENABLED ZREF
FK_B_TR_CC TRADE_REQUEST ENABLED ZREF
FK_C_CA_CC CUSTOMER_ACCOUNT ENABLED ZREF
FK_C_CX_CC CUSTOMER_TAXRATE ENABLED ZREF
FK_C_WL_CC WATCH_LIST ENABLED ZREF
FK_CA_AP_CC ACCOUNT_PERMISSION ENABLED ZREF
FK_CA_HS_CC HOLDING_SUMMARY ENABLED ZREF
FK_CA_T_CC TRADE ENABLED ZREF
FK_CO_CP_CC COMPANY_COMPETITOR ENABLED ZREF
FK_CO_CP_CC2 COMPANY_COMPETITOR ENABLED ZREF
FK_CO_FI_CC FINANCIAL ENABLED ZREF
FK_CO_NX_CC NEWS_XREF ENABLED ZREF
FK_CO_S_CC SECURITY ENABLED ZREF
FK_EX_CR_CC COMMISSION_RATE ENABLED ZREF
FK_EX_S_CC SECURITY ENABLED ZREF
FK_HS_H_CC HOLDING ENABLED ZREF
FK_IN_CO_CC COMPANY ENABLED ZREF
FK_IN_CP_CC COMPANY_COMPETITOR ENABLED ZREF
FK_NI_NX_CC NEWS_XREF ENABLED ZREF
FK_S_DM_CC DAILY_MARKET ENABLED ZREF
FK_S_HS_CC HOLDING_SUMMARY ENABLED ZREF
FK_S_LT_CC LAST_TRADE ENABLED ZREF
FK_S_T_CC TRADE ENABLED ZREF
FK_S_TR_CC TRADE_REQUEST ENABLED ZREF
FK_S_WI_CC WATCH_ITEM ENABLED ZREF
FK_SC_IN_CC INDUSTRY ENABLED ZREF
FK_ST_B_CC BROKER ENABLED ZREF
FK_ST_C_CC CUSTOMER ENABLED ZREF
FK_ST_CO_CC COMPANY ENABLED ZREF
FK_ST_S_CC SECURITY ENABLED ZREF
FK_ST_T_CC TRADE ENABLED ZREF
FK_ST_TH_CC TRADE_HISTORY ENABLED ZREF
FK_T_CT_CC CASH_TRANSACTION ENABLED ZREF
FK_T_H_CC HOLDING ENABLED ZREF
FK_T_HH_CC HOLDING_HISTORY ENABLED ZREF
FK_T_HH_CC2 HOLDING_HISTORY ENABLED ZREF
FK_T_SE_CC SETTLEMENT ENABLED ZREF
FK_T_TH_CC TRADE_HISTORY ENABLED ZREF
FK_T_TR_CC TRADE_REQUEST ENABLED ZREF
FK_TT_CH_CC CHARGE ENABLED ZREF
FK_TT_CR_CC COMMISSION_RATE ENABLED ZREF
FK_TT_T_CC TRADE ENABLED ZREF
FK_TT_TR_CC TRADE_REQUEST ENABLED ZREF
FK_TX_CX_CC CUSTOMER_TAXRATE ENABLED ZREF
FK_WL_WI_CC WATCH_ITEM ENABLED ZREF
FK_ZC_AD_CC ADDRESS01 ENABLED ZREF
```
